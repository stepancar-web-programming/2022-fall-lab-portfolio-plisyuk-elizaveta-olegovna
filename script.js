...
const slides = document.getElementsByClassName('slides-items')
const prevB = document.getElementById('left-button')
const nextB = document.getElementById('right-button')
let slideIndex = 1
